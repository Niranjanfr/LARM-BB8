...
: ${AMENT_CURRENT_PREFIX:="/home/imtld.local/niranjan.kulkarni/git/install/mb6_basic"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mb6_basic/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mb6_basic/environment/path.sh"
